...
public class Shooter extends NRSubsystem
{
   ...
   public static double F_VEL_SHOOTER = 0.08;
   public static double P_VEL_SHOOTER = 0.2;
   ...
   public static final AngularSpeed MAX_SPEED = new AngularSpeed(5000, Angle.Unit.ROTATION, Time.Unit.MINUTE);
   ...
   private Shooter()
   {
       if(EnabledSubsystems.SHOOTER_ENABLED) {
           shooterTalon1 = new TalonSRX(RobotMap.SHOOTER_TALON1);
           shooterTalon2 = new TalonSRX(RobotMap.SHOOTER_TALON2);
           ...
           shooterTalon1.configPeakCurrentDuration(50, DEFAULT_TIMEOUT);
           shooterTalon2.enableCurrentLimit(true);
           shooterTalon2.configPeakCurrentLimit(PEAK_CURRENT_SHOOTER, DEFAULT_TIMEOUT);
           shooterTalon2.configPeakCurrentDuration(50, DEFAULT_TIMEOUT);
   ...
   public AngularSpeed getSpeedShooter1(){
       if(shooterTalon1 != null){
           return new AngularSpeed(shooterTalon1.getSelectedSensorVelocity(), Angle.Unit.SHOOTER_ENCODER_TICK, Time.Unit.HUNDRED_MILLISECOND);
       }
   ...
   public AngularSpeed getSpeedShooter2()
   {
       if(shooterTalon2 != null)
       {
           return new AngularSpeed(shooterTalon2.getSelectedSensorVelocity(), Angle.Unit.SHOOTER_ENCODER_TICK, Time.Unit.HUNDRED_MILLISECOND);
       }
       return AngularSpeed.ZERO;
   }
   ...
   public void setMotorSpeed(AngularSpeed speed){
       if(shooterTalon1 != null){
        ...
        //   shooterTalon1.set(ControlMode.Velocity, -17060);
           shooterTalon1.set(ControlMode.Velocity, goalSpeed.get(Angle.Unit.SHOOTER_ENCODER_TICK, Time.Unit.HUNDRED_MILLISECOND));
