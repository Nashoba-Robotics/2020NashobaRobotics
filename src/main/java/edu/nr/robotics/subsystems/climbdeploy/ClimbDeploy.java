...
public class ClimbDeploy extends NRSubsystem{
   ...
   private TalonSRX climbDeployTalon, climbFollow1;
   private VictorSPX climbFollow2;
   ...
   private ClimbDeploy(){
       if(EnabledSubsystems.CLIMB_DEPLOY_ENABLED){
        ...
        //   climbFollow1 = CTRECreator.createFollowerTalon(6, climbDeployTalon); for testing w/2019 elevator
        //   climbFollow2 = CTRECreator.createFollowerVictor(5, climbDeployTalon);
