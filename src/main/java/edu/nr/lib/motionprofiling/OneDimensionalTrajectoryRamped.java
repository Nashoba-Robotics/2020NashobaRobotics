...
public class OneDimensionalTrajectoryRamped implements OneDimensionalTrajectory {
    ...
    double totalTime; //Total time of Motion profile
    double timeRamp;
    double timeAccel;
    double timeCruise; //Time that the robot is cruising at velMax
    ...
    public OneDimensionalTrajectoryRamped(double goalPositionDelta, double velMax, double accelMax, double timeMult) {
        ...
        calcTimes();
        this.loadPosPoints(1);
        this.loadVelPoints(1);
        this.loadAccelPoints(1);
    }
